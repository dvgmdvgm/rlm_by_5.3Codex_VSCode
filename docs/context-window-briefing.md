...
- `memory/logs/cloud_payload_audit.md` is append-only audit history (one block per major tool response).
- `memory/logs/cloud_payload_current.md` is a single overwrite snapshot of the latest cloud-facing payload.
